...
#     # Deterministic rules first to avoid misclassification of greetings / simple questions
#     identity_phrases = [
#         "who are you",
#         "what are you",
#         "your name",
...
#     # Treat short/factual/how-to style queries as casual/general
#     if query_lower.startswith(("how to", "how do i", "how do you", "what is", "what's", "how does")):
#         return "casual"

#     # fallback to model-based classification for ambiguous queries
#     try:
...
#             "I help you understand company policies, benefits, and guidelines. "
...
#     # defensive: ensure answer is string
#     if answer is None:
#         answer = ""
...
#         if status == "casual":
#             response_text = answer   # already generated in run_rag

#         elif status in ["empty", "guard"]:
...
if st.session_state.pending_query:
    ...
    if not st.session_state.pipeline_ready:
        ...
        # ✅ FIX: Always append assistant message to session state
        # Create the assistant message dict
        assistant_msg = {
            "role": "assistant",
            "content": answer,
            "sources": sources,
