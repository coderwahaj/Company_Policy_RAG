...
//   ].join(" ")}
// >
//       <div className="h-full min-h-0 p-3 md:p-4 overflow-y-auto scroll-on-hover scroll-smooth">
...
//                 className="w-full rounded-xl border border-white/15 bg-black/30 px-3 py-2.5 text-sm text-slate-100 outline-none focus:border-cyan-300/50"
//               >
...
//                 className="w-fit rounded-xl bg-gradient-to-r from-cyan-300 to-violet-300 px-4 py-2.5 text-sm font-semibold text-slate-900 hover:brightness-110"
//               >
//                 Load Pipeline
//               </button>
...
//                   <p>
//                     Total Chunks:{" "}
//                     <span className="text-slate-100">{chunkCount}</span>
//                   </p>
//                   <p>
//                     Messages:{" "}
//                     <span className="text-slate-100">{messagesCount}</span>
//                   </p>
//                 </div>
//               </div>
//             )}
...
//                     className="w-fit max-w-full rounded-lg border border-white/10 bg-white/[0.03] px-3 py-2 text-left text-xs text-slate-200 hover:border-cyan-300/30 hover:bg-cyan-300/10"
//                   >
...
//               onClick={onLoadPipeline}
//               title="Load Pipeline"
//               className="grid h-10 w-10 place-items-center rounded-xl bg-gradient-to-r from-cyan-300 to-violet-300 text-slate-900 hover:brightness-110"
//             >
//               ⬆
//             </button>
//             <button
...
//               className="grid h-10 w-10 place-items-center rounded-xl border border-white/15 bg-white/[0.04] text-slate-200 hover:bg-white/[0.08]"
//             >
//               ↺
//             </button>
//             <button
